...
All preprocess files are taken from https://github.com/edebrouwer/gru_ode_bayes ; the one which return the raw file for the project is mimic_prep.ipynb (from Hi-Patch repo).
Execute all gru_oe_bayes files, then mimic_prep.ipynb and finally you obtain the full_dataset.csv as raw file.
